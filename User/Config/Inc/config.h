...
/**
 * @brief Simulink 反馈帧速度字段格式（编译期）
 * @note  0：电机/输出轴/倒立摆摆杆为 °/s
 *        1：电机 0.1rpm；输出轴与倒立摆摆杆 1rpm（rpm = °/s / 6）
 *        软尺摆模式下 s32PendulumSpeed 仍为 ADC3 原始码，不受本开关影响
 */
#define FEEDBACK_SPEED_USE_RPM_FORMAT        1U
