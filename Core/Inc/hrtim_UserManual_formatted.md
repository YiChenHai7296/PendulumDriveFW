...
- **HAL**：提供 `HRTIM_HandleTypeDef`、`HAL_HRTIM_*` 等
- **main.h**：提供 `FunctionalState`、`MotorEnableControl_GPIO_Port`/`Pin`、`MotorDirectionControl_GPIO_Port`/`Pin`
- **usart 或其它模块**：提供 `DEBUG_UART`、`u8DebugRxBuff`（供 `PWM_TEST` 及回调中的 printf 使用）
